                ...
                <header>
                    ...
                    <c:choose>
                        <c:when test="${acao == 'incluir'}">
                            <h2><i class="fas fa-users"></i>CADASTRAR NOVO FUNCIONÁRIO</h2>
                        </c:when>
                        <c:when test="${acao == 'alterar'}">
                            <h2><i class="fas fa-users"></i>EDITAR FUNCIONÁRIO</h2>
                        </c:when>
                    </c:choose>
                    ...
                    <div class="container">
                        ...
                        <c:choose>
                            <c:when test="${acao == 'incluir'}">
                                ...
                                <form  method="post" action="${pageContext.request.contextPath}/protegido/funcionario_salvar">
                                    <!-- ID USUÃRIO  -->
                            ...
                            <c:when test="${acao == 'alterar'}">
                                ...
                                <!-- FORM EDITAR USUÁRIO-->
                                <form  method="post" action="${pageContext.request.contextPath}/protegido/funcionario_update">
                                    <!-- ID USUÃRIO  -->
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">ID USUÁRIO: </label>
                                        <div class="col-lg-10">
