            ...
            <main id="mainContent">
                ...
                <div class="main-content">
                    ...
                    <div class="container">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="botoesTabela">
                                                    <a href="${pageContext.request.contextPath}/protegido/cliente_editar?id=${cli.getIdCliente()}" class="botaoEditar"><i class="fas fa-edit"></i></a>
                        ...
                        <!-- fim tableScrow-->
                        <a href="${pageContext.request.contextPath}/protegido/cliente_novo" class="botao">Incluir novo</a>
                    </div>
                    <!-- fim container-->
