...
public class Filtro implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        System.out.println("Nome: " + funcionario.getNome() + " cidadef: " + funcionario.getCidade());
    ...
    private boolean verificarAcesso(Funcionario funcionario, HttpServletRequest httpRequest) {
        ...
        if (urlAcessada.endsWith("/home")) {
            ...
            return true;
        } else if (urlAcessada.endsWith("/protegido/funcionario_editar") && departamento.equals("Tecnologia")) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/funcionario_salvar") && departamento.equals("Tecnologia")) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/funcionario_update") && departamento.equals("Tecnologia")) {
            return true;
            ...
            return true;
        } else if (urlAcessada.endsWith("/protegido/filial_editar") && departamento.equals("Tecnologia")) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/filial_salvar") && departamento.equals("Tecnologia")) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/filial_update") && departamento.equals("Tecnologia")) {
            return true;
            ...
            return true;
        } else if (urlAcessada.endsWith("/protegido/carrinho_excluir") && (departamento.equals("Tecnologia") || departamento.equals("Vendas") || departamento.equals("Diretoria") || departamento.equals("Gerencia"))) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/finalizarVenda") && (departamento.equals("Tecnologia") || departamento.equals("Vendas") || departamento.equals("Diretoria") || departamento.equals("Gerencia"))) {
            return true;
            ...
            return true;
        } else if (urlAcessada.endsWith("/protegido/produto_editar") && (departamento.equals("Tecnologia") || departamento.equals("Marketing/Produtos"))) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/produto_salvar") && (departamento.equals("Tecnologia") || departamento.equals("Marketing/Produtos"))) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/produto_update") && (departamento.equals("Tecnologia") || departamento.equals("Marketing/Produtos"))) {
            return true;
            ...
            return true;
        } else if (urlAcessada.endsWith("/protegido/cliente_editar") && (departamento.equals("Tecnologia") || departamento.equals("Vendas"))) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/cliente_salvar") && (departamento.equals("Tecnologia") || departamento.equals("Vendas"))) {
            return true;
        } else if (urlAcessada.endsWith("/protegido/cliente_update") && (departamento.equals("Tecnologia") || departamento.equals("Vendas"))) {
            return true;
